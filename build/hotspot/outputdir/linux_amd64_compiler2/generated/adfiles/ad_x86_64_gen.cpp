...
MachOper *State::MachOperGenerator(int opcode, Compile* C){
  ...
  case IMMP_POLL:
    return new (C) immP_pollOper(_leaf->bottom_type()->is_ptr() );
  case IMMN:
...
MachNode *State::MachNodeGenerator(int opcode, Compile* C){
  ...
  case loadConP_poll_rule:  {
      loadConP_pollNode *node = new (C) loadConP_pollNode();
      node->_opnd_array[1] = new (C) immP_pollOper(_leaf->bottom_type()->is_ptr() );
      return node;
    }
  ...
  case Repl8B_rRegI_rule:  {
      Repl8B_rRegINode *node = new (C) Repl8B_rRegINode();
      return node;
    }
  ...
  case Repl4S_rRegI_rule:  {
      Repl4S_rRegINode *node = new (C) Repl4S_rRegINode();
      return node;
    }
  ...
  case Repl4C_rRegI_rule:  {
      Repl4C_rRegINode *node = new (C) Repl4C_rRegINode();
      return node;
    }
  ...
  case Repl2I_rRegI_rule:  {
      Repl2I_rRegINode *node = new (C) Repl2I_rRegINode();
      return node;
    }
  ...
  case Repl2F_regF_rule:  {
      Repl2F_regFNode *node = new (C) Repl2F_regFNode();
      return node;
    }
  case Repl2F_immF0_rule:  {
      Repl2F_immF0Node *node = new (C) Repl2F_immF0Node();
      return node;
    }
  case rep_stos_rule:  {
