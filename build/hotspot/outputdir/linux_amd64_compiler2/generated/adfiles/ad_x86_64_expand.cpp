...
const RegMask ANY_REG_mask( 0xffffffff, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_REG_mask( 0xffffcff, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask STACK_OR_PTR_REG_mask( 0xffffcff, 0x0, 0xfffffffc, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask PTR_NO_RAX_REG_mask( 0xfcffcff, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_NO_RBP_REG_mask( 0xf3ffcff, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_NO_RAX_RBX_REG_mask( 0xfcfccff, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_RAX_REG_mask( 0x300000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_RBX_REG_mask( 0x3000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_RSI_REG_mask( 0xc0000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_RDI_REG_mask( 0xc000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_RBP_REG_mask( 0xc00000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_RSP_REG_mask( 0xc0000000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask PTR_R15_REG_mask( 0x30000000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask LONG_REG_mask( 0xffffcff, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask STACK_OR_LONG_REG_mask( 0xffffcff, 0x0, 0xfffffffc, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask LONG_NO_RAX_RDX_REG_mask( 0xfccfcff, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask LONG_NO_RCX_REG_mask( 0xffff0ff, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask LONG_NO_RAX_REG_mask( 0xfcffcff, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask LONG_RAX_REG_mask( 0x300000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask LONG_RCX_REG_mask( 0xc00, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask LONG_RDX_REG_mask( 0x30000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INT_REG_mask( 0x5555455, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask STACK_OR_INT_REG_mask( 0x5555455, 0x0, 0xfffffffc, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask INT_NO_RCX_REG_mask( 0x5555055, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INT_NO_RAX_RDX_REG_mask( 0x5445455, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INT_RAX_REG_mask( 0x100000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INT_RBX_REG_mask( 0x1000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INT_RCX_REG_mask( 0x400, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INT_RDX_REG_mask( 0x10000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INT_RDI_REG_mask( 0x4000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INT_FLAGS_mask( 0x0, 0x0, 0x1, 0x0, 0x0, 0x0 );
const RegMask FLOAT_REG_mask( 0x0, 0x55555555, 0x0, 0x0, 0x0, 0x0 );
const RegMask STACK_OR_FLOAT_REG_mask( 0x0, 0x55555555, 0xfffffffc, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask DOUBLE_REG_mask( 0x0, 0xffffffff, 0x0, 0x0, 0x0, 0x0 );
const RegMask STACK_OR_DOUBLE_REG_mask( 0x0, 0xffffffff, 0xfffffffc, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask STACK_SLOTS_mask( 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask STACK_OR_STACK_SLOTS_mask( 0x0, 0x0, 0xfffffffc, 0xffffffff, 0xffffffff, 0xffffffff );
const RegMask INLINE_CACHE_REG_mask( 0x100000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INTERPRETER_METHOD_OOP_REG_mask( 0x1000, 0x0, 0x0, 0x0, 0x0, 0x0 );
const RegMask INTERPRETER_FRAME_POINTER_REG_mask( 0x400000, 0x0, 0x0, 0x0, 0x0, 0x0 );
...
MachNode* storeIConditionalNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  // DEF/KILL oldval
  MachProjNode *kill;
  kill = new (C, 1) MachProjNode( this, 1, (INT_RAX_REG_mask), Op_RegI );
  proj_list.push(kill);
...
MachNode* storeLConditionalNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  // DEF/KILL oldval
  MachProjNode *kill;
  kill = new (C, 1) MachProjNode( this, 1, (LONG_RAX_REG_mask), Op_RegL );
  proj_list.push(kill);
...
MachNode* compareAndSwapPNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  // DEF/KILL oldval
  MachProjNode *kill;
  kill = new (C, 1) MachProjNode( this, 1, (PTR_RAX_REG_mask), Op_RegP );
  proj_list.push(kill);
  // DEF/KILL cr
...
MachNode* compareAndSwapNNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  // DEF/KILL oldval
  MachProjNode *kill;
  kill = new (C, 1) MachProjNode( this, 1, (INT_RAX_REG_mask), Op_RegN );
  proj_list.push(kill);
  // DEF/KILL cr
  kill = new (C, 1) MachProjNode( this, 2, (INT_FLAGS_mask), Op_RegFlags );
  proj_list.push(kill);
...
MachNode* divI_rRegNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  // DEF/KILL rdx
  MachProjNode *kill;
  kill = new (C, 1) MachProjNode( this, 1, (INT_RDX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // DEF/KILL cr
  kill = new (C, 1) MachProjNode( this, 2, (INT_FLAGS_mask), Op_RegFlags );
  proj_list.push(kill);
...
MachNode* divL_rRegNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  // DEF/KILL rdx
  MachProjNode *kill;
  kill = new (C, 1) MachProjNode( this, 1, (LONG_RDX_REG_mask), Op_RegL );
  proj_list.push(kill);
  // DEF/KILL cr
  kill = new (C, 1) MachProjNode( this, 2, (INT_FLAGS_mask), Op_RegFlags );
  proj_list.push(kill);
...
MachNode* cadd_cmpLTMaskNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  unsigned num4 = opnd_array(4)->num_edges();
  unsigned num5 = opnd_array(5)->num_edges();
  unsigned num6 = opnd_array(6)->num_edges();
  unsigned idx0 = oper_input_base();
  unsigned idx1 = idx0 + num0;
  unsigned idx2 = idx1 + num1;
  unsigned idx3 = idx2 + num2;
...
MachNode* rep_stosNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  // DEF/KILL cnt
  MachProjNode *kill;
  kill = new (C, 1) MachProjNode( this, 1, (LONG_RCX_REG_mask), Op_RegL );
  proj_list.push(kill);
  // DEF/KILL base
  kill = new (C, 1) MachProjNode( this, 2, (PTR_RDI_REG_mask), Op_RegP );
  proj_list.push(kill);
  // DEF/KILL zero
  kill = new (C, 1) MachProjNode( this, 3, (INT_RAX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // DEF/KILL cr
...
MachNode* string_compareNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  // DEF/KILL str1
  MachProjNode *kill;
  kill = new (C, 1) MachProjNode( this, 1, (PTR_RDI_REG_mask), Op_RegP );
  proj_list.push(kill);
  // DEF/KILL cnt1
  kill = new (C, 1) MachProjNode( this, 2, (INT_RCX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // DEF/KILL str2
  kill = new (C, 1) MachProjNode( this, 3, (PTR_RSI_REG_mask), Op_RegP );
  proj_list.push(kill);
  // DEF/KILL cnt2
  kill = new (C, 1) MachProjNode( this, 4, (INT_RDX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // TEMP tmp1
  MachTempNode *def;
...
MachNode* string_indexof_conNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  proj_list.push(kill);
  // DEF/KILL cnt1
  kill = new (C, 1) MachProjNode( this, 2, (INT_RDX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // DEF/KILL str2
  kill = new (C, 1) MachProjNode( this, 3, (PTR_RSI_REG_mask), Op_RegP );
  proj_list.push(kill);
  ...
  add_req(def);
  // DEF/KILL cnt2
  kill = new (C, 1) MachProjNode( this, 4, (INT_RAX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // DEF/KILL tmp
  kill = new (C, 1) MachProjNode( this, 5, (INT_RCX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // DEF/KILL cr
...
MachNode* string_equalsNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  proj_list.push(kill);
  // DEF/KILL str2
  kill = new (C, 1) MachProjNode( this, 2, (PTR_RSI_REG_mask), Op_RegP );
  proj_list.push(kill);
  // DEF/KILL cnt
  kill = new (C, 1) MachProjNode( this, 3, (INT_RCX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // TEMP tmp1
  MachTempNode *def;
  def = new (C) MachTempNode(state->MachOperGenerator( REGD, C ));
  ...
  add_req(def);
  // DEF/KILL tmp3
  kill = new (C, 1) MachProjNode( this, 4, (INT_RBX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // DEF/KILL cr
  kill = new (C, 1) MachProjNode( this, 5, (INT_FLAGS_mask), Op_RegFlags );
  proj_list.push(kill);
...
MachNode* partialSubtypeCheckNode::Expand(State* state, Node_List& proj_list, Node* mem) {
  ...
  // DEF/KILL rcx
  MachProjNode *kill;
  kill = new (C, 1) MachProjNode( this, 1, (INT_RCX_REG_mask), Op_RegI );
  proj_list.push(kill);
  // DEF/KILL cr
  kill = new (C, 1) MachProjNode( this, 2, (INT_FLAGS_mask), Op_RegFlags );
  proj_list.push(kill);
