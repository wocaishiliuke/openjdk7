...
const Pipeline *                      loadA8BNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                      loadA8BNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                      loadA4SNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                      loadA4SNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                      loadA4CNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                      loadA4CNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                      load2IUNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                      load2IUNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                      loadA2FNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                      loadA2FNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                loadConP_pollNode::pipeline_class() { return (&pipeline_class_003); }
const Pipeline *                loadConP_pollNode::pipeline() const { return (&pipeline_class_003); }
...
const Pipeline *                    prefetchwNode::pipeline_class() { return (&pipeline_class_010); }
const Pipeline *                    prefetchwNode::pipeline() const { return (&pipeline_class_010); }
...
const Pipeline *                  prefetchwT0Node::pipeline_class() { return (&pipeline_class_010); }
const Pipeline *                  prefetchwT0Node::pipeline() const { return (&pipeline_class_010); }

const Pipeline *                  prefetchwT2Node::pipeline_class() { return (&pipeline_class_010); }
const Pipeline *                  prefetchwT2Node::pipeline() const { return (&pipeline_class_010); }
...
const Pipeline *                     storeA8BNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                     storeA8BNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                     storeA4CNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                     storeA4CNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                     storeA2INode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                     storeA2INode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                     storeA2FNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                     storeA2FNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                  loadLLockedNode::pipeline_class() { return (&pipeline_class_009); }
const Pipeline *                  loadLLockedNode::pipeline() const { return (&pipeline_class_009); }
...
const Pipeline *                   Repl8B_regNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                   Repl8B_regNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                 Repl8B_rRegINode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                 Repl8B_rRegINode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                 Repl8B_immI0Node::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                 Repl8B_immI0Node::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                   Repl4S_regNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                   Repl4S_regNode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                 Repl4S_rRegINode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                 Repl4S_rRegINode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                 Repl4S_immI0Node::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                 Repl4S_immI0Node::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                   Repl4C_regNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                   Repl4C_regNode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                 Repl4C_rRegINode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                 Repl4C_rRegINode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                 Repl4C_immI0Node::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                 Repl4C_immI0Node::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                   Repl2I_regNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                   Repl2I_regNode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                 Repl2I_rRegINode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                 Repl2I_rRegINode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                 Repl2I_immI0Node::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                 Repl2I_immI0Node::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                   Repl2F_regNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                   Repl2F_regNode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                  Repl2F_regFNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                  Repl2F_regFNode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *                 Repl2F_immF0Node::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *                 Repl2F_immF0Node::pipeline() const { return (&pipeline_class_023); }
